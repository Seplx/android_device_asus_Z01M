...
$(LOCAL_BUILT_MODULE): ACTUAL_BIN_FILE := /etc/persist/WCNSS_qcom_wlan_nv.bin
$(LOCAL_BUILT_MODULE): WCNSS_BIN_SYMLINK := $(TARGET_OUT)/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin

$(LOCAL_BUILT_MODULE): ACTUAL_BIN_Z01M_FILE := /etc/persist/WCNSS_qcom_wlan_nv_Phoenix.bin
$(LOCAL_BUILT_MODULE): WCNSS_BIN_Z01M_SYMLINK := $(TARGET_OUT)/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv_Phoenix.bin

$(LOCAL_BUILT_MODULE): ACTUAL_DAT_FILE := /etc/persist/WCNSS_wlan_dictionary.dat
