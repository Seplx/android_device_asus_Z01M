...
ifneq ($(filter Z01M,$(TARGET_DEVICE)),)
...
$(LOCAL_BUILT_MODULE): ACTUAL_BIN_FILE := /system/etc/persist/WCNSS_qcom_wlan_nv.bin
$(LOCAL_BUILT_MODULE): WCNSS_BIN_SYMLINK := $(TARGET_OUT)/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin

$(LOCAL_BUILT_MODULE): ACTUAL_BIN_Z01M_FILE := /system/etc/persist/WCNSS_qcom_wlan_nv_Phoenix.bin
$(LOCAL_BUILT_MODULE): WCNSS_BIN_Z01M_SYMLINK := $(TARGET_OUT)/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv_Phoenix.bin

$(LOCAL_BUILT_MODULE): ACTUAL_DAT_FILE := /system/etc/persist/WCNSS_wlan_dictionary.dat
...
$(LOCAL_BUILT_MODULE):
	...
	$(hide) rm -rf $(WCNSS_BIN_Z01M_SYMLINK)
	$(hide) ln -sf $(ACTUAL_BIN_Z01M_FILE) $(WCNSS_BIN_Z01M_SYMLINK)
